...
namespace SemanticBlazor
{
  public class JsFunc
  {
    ...
    public class Modal
    {
      public static async Task Show(IJSRuntime jsRuntime, string id)
      {
        await jsRuntime.InvokeAsync<object>("SemanticModal.Show", id);
      }
    ...
    public class DateTimeInput
    {
      ...
      public static async Task InitTimeCalendar(IJSRuntime jsRuntime, string id)
      {
        await jsRuntime.InvokeAsync<object>("SemanticDateTimeInput.InitDateCalendar", id);
      }
